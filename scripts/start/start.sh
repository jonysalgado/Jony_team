...
player="${DIR}/../../binaries/Jony_team_player"
coach="${DIR}/../../binaries/Jony_team_player"
teamname="Jony_team"
host="localhost"
port=6000
coach_port=""
...
player_conf="${DIR}/../../source/core/player/config/player.conf"
config_dir="${DIR}/../../source/core/player/config/formations-dt"

coach_conf="${DIR}/../../source/core/player/config/coach.conf"
